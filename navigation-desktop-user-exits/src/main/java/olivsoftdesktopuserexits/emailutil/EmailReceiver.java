...
public class EmailReceiver
{
  ...
  public EmailReceiver(String provider) throws RuntimeException
  {
    ...
    EmailReceiver.sendEmailsTo     = props.getProperty("ue.send.emails.to");
    EmailReceiver.acceptEmailsFrom = props.getProperty("ue.accept.emails.from");
    EmailReceiver.acceptSubject    = props.getProperty("ue.email.subject");
    EmailReceiver.ackSubject       = props.getProperty("ue.ack.subject");
    
    EmailReceiver.protocol     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.protocol");
    EmailReceiver.outgoingPort = Integer.parseInt(props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "outgoing.server.port", "0"));
    EmailReceiver.incomingPort = Integer.parseInt(props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "incoming.server.port", "0"));
    EmailReceiver.username     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.username",   "");
    EmailReceiver.password     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.password",   "");
    EmailReceiver.outgoing     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "outgoing.server", "");
    EmailReceiver.incoming     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "incoming.server", "");
    EmailReceiver.replyto      = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.replyto",    "");
    EmailReceiver.smtpauth     = "true".equals(props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.smtpauth", "false"));
