package olivsoftdesktopuserexits.emailutil;
...
public class EmailSender
{
  ...
  public EmailSender(String provider) throws RuntimeException
  {
    ...
    EmailSender.sendEmailsTo = props.getProperty("ue.send.emails.to");
    EmailSender.eventSubject = props.getProperty("ue.event.subject");
    
    EmailSender.protocol     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.protocol");
    EmailSender.outgoingPort = Integer.parseInt(props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "outgoing.server.port", "0"));
    EmailSender.incomingPort = Integer.parseInt(props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "incoming.server.port", "0"));
    EmailSender.username     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.username",   "");
    EmailSender.password     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.password",   "");
    EmailSender.outgoing     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "outgoing.server", "");
    EmailSender.incoming     = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "incoming.server", "");
    EmailSender.replyto      = props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.replyto",    "");
    EmailSender.smtpauth     = "true".equals(props.getProperty("ue." + (provider != null ? (provider + ".") : "") + "mail.smtpauth", "false"));
  ...
  {
    send(EmailSender.eventSubject, content);
  }
  ...
  public void send(String subject, 
    ...
    throws MessagingException, AddressException
  {
    send(EmailSender.sendEmailsTo.split(","), subject, content);
  }
  ...
  public void send(String subject, 
    ...
    throws MessagingException, AddressException
  {
    send(EmailSender.sendEmailsTo.split(","), subject, content, attachment);
  }
