...
{
//public final static String VERSION_NUMBER = "3.0.0.4"; // In sync with Weather Wizard and Navigation Desktop
//public final static String VERSION_NUMBER = "3.0.1.0"; // In sync with Weather Wizard and Navigation Desktop
//public final static String VERSION_NUMBER = "3.0.1.1"; // In sync with Weather Wizard and Navigation Desktop
//public final static String VERSION_NUMBER = "3.0.1.2"; // In sync with Weather Wizard and Navigation Desktop
//public final static String VERSION_NUMBER = "3.0.1.3"; // In sync with Weather Wizard and Navigation Desktop
//public final static String VERSION_NUMBER = "3.0.1.4"; // In sync with Weather Wizard and Navigation Desktop
//public final static String VERSION_NUMBER = "3.0.1.5"; // In sync with Weather Wizard and Navigation Desktop
       ...
       public void updateCompleted(List<String> fList)
       {
         ...
         if (fList != null && fList.size() > 0)
         {
           ...
           for (String s : fList)
             downloadMess += (s + "\n");
           // Display file list
           System.out.println("Software update requested for:\n" + downloadMess);
