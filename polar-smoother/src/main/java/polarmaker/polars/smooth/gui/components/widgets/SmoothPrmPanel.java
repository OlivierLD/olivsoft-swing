...
//    jLabel1.setText(LogisailResourceBundle.getLogisailResourceBundle().getString("polar-degree"));
//    jLabel2.setText(LogisailResourceBundle.getLogisailResourceBundle().getString("coeff-degree"));
