...
//    System.out.println("Building JTree from XML");
  ...
  private static void xmlToJTree(PolarTreeNode parent, Node node) throws Exception
  {
    ...
    else if (node.getNodeName().equals("tws"))
    {
      ...
      try { value_2 = Double.parseDouble(nnm.getNamedItem("upwind-speed").getNodeValue()); } catch (Exception ignore){}
      try { value_3 = Double.parseDouble(nnm.getNamedItem("upwind-twa").getNodeValue()); } catch (Exception ignore){}
      try { value_4 = Double.parseDouble(nnm.getNamedItem("upwind-vmg").getNodeValue()); } catch (Exception ignore){}
      try { value_5 = Double.parseDouble(nnm.getNamedItem("downwind-speed").getNodeValue()); } catch (Exception ignore){}
      try { value_6 = Double.parseDouble(nnm.getNamedItem("downwind-twa").getNodeValue()); } catch (Exception ignore){}
      try { value_7 = Double.parseDouble(nnm.getNamedItem("downwind-vmg").getNodeValue()); } catch (Exception ignore){}
