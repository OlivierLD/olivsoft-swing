        ...
        else if (ptn.getType() == PolarTreeNode.TWS_TYPE)
        {
          ...
          if (resp == JOptionPane.OK_OPTION)
          {
            try
            {
              ...
              try { bspvmgu = etp.getBspVmgUp(); } catch (Exception ignore) {}
              double twavmgu = Double.MIN_VALUE;
              try { twavmgu = etp.getTwaVmgUp(); } catch (Exception ignore) {}
              double vmgu = Double.MIN_VALUE;
              try { vmgu = etp.getVmgUp(); } catch (Exception ignore) {}
              double bspvmgd = Double.MIN_VALUE;
              try { bspvmgd = etp.getBspVmgDown(); } catch (Exception ignore) {}
              double twavmgd = Double.MIN_VALUE;
              try { twavmgd = etp.getTwaVmgDown(); } catch (Exception ignore) {}
              double vmgd = Double.MIN_VALUE;
              try { vmgd = etp.getVmgDown(); } catch (Exception ignore) {}
