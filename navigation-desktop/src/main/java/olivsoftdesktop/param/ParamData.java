...
public class ParamData // TODO Change this to an enum...
{                                                             // Sample values:
                                                              // -------------------------
  public final static int NMEA_CHANNEL                 =  0;  // Serial, TCP, UDP
  public final static int NMEA_SERIAL_PORT             =  1;  // COMXX, /dev/ttyUSB0, etc
  ...
  public final static int NMEA_BAUD_RATE               =  9;  // 4800, 9600, etc
  ...
  public final static int SHOW_WEB_W_TEMP              = 41;
  public final static int SHOW_WEB_A_TEMP              = 42;
  public final static int SHOW_WEB_GDT                 = 43;
  public final static int SHOW_WEB_PRMSL               = 44;
  public final static int SHOW_WEB_HUM                 = 45;
  public final static int SHOW_WEB_VOLT                = 46;

  public final static int NMEA_AT_STARTUP              = 47;
  public final static int LWP_AT_STARTUP               = 48;
  public final static int LWP_GLOSSY_DISPLAY           = 49;

  public final static int DEFAULT_LAT                  = 50;  // For Off-line usage (No NMEA data)
  public final static int DEFAULT_LON                  = 51;  // For Off-line usage (No NMEA data)

  public final static int NB_PARAMETERS                = 52;
  ...
  private final static String[] LABELS =
  {
    ...
    "Airmail ID",                                                              // 40
    //
    "Water Temperature in the Web Console(s)",                                 // 41
    "Air Temperature in the Web Console(s)",                                   // 42
    "GPS Date & Time in the Web Console(s)",                                   // 43
    "Atmospheric Pressure in the Web Console(s)",                              // 44
    "Relative Humidity in the Web Console(s)",                                 // 45
    "Voltage in the Web Console(s)",                                           // 46
    //
    "Start reading NMEA port at startup",                                      // 47
    "Start Live Wallpaper at startup",                                         // 48
    "Glossy displays on Live Wallpaper",                                       // 49

    "Default Latitude (when no GPS)",                                          // 50
    "Default Longitude (when no GPS)",                                         // 51
  };
  ...
  private final static String[] HELPTEXT =
  {
    ...
    /* 41 */ "Show Water Temperature in the Web Console(s)",
    /* 42 */ "Show Air Temperature in the Web Console(s) (requires sensor & user-exit)",  
    /* 43 */ "Show GPS Date & Time in the Web Console(s) (requires sensor & user-exit)",  
    /* 44 */ "Show Atmospheric Pressure in the Web Console(s) (requires sensor & user-exit)",
    /* 45 */ "Show Relative Himidity in the Web Console(s) (requires sensor & user-exit)",   
    /* 46 */ "Show Voltage in the Web Console(s) (requires sensor & user-exit)",
    /* 47 */ "If defined, start reading NMEA port when the Desktop starts",
    /* 48 */ "Display the live wallpaper when the Desktop starts",
    /* 49 */ "Show glossy (opaque) displays on the live wallpaper. Requires restart when changed.",
    /* 50 */ "Default latitude, when no GPS data is available.",
    /* 51 */ "Default longitude, when no GPS data is available."
  };
