...
public class ChartLibInternalFrame
...
//private JMenuItem menuFileExit = new JMenuItem();
  ...
  private ChartLibInternalFrame instance = null;

  private transient ChartLibListener cll = new ChartLibListener()
      {
  ...
  public ChartLibInternalFrame(Connection c)
  {
    conn = c;
    instance = this;
    try
    ...
    ChartLibContext.getInstance().addChartLibListener(cll);
  }
    ...
    throws Exception
  {
    ...
    try { this.setFrameIcon(new ImageIcon(this.getClass().getResource("book.gif"))); } catch (Exception ignore) { System.err.println(ignore.toString()); }
...
//  menuFile.add(menuFileExit);
  ...
  {
    ChartLibContext.getInstance().fireInternalFrameClosed();
    ChartLibContext.getInstance().removeChartLibListener(cll);
  }
}
