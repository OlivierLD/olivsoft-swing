...
//  setSize(imgWidth, imgHeight);
    ...
    imgHolder.setBounds(0,0,325,200);
    ...
    // 169 = Copyright
    copyrightLabel.setText((char)169  + " 2007 and beyond, Oliv did it.");
    copyrightLabel.setForeground(Color.red);

    loadingLabel.setText("Loading charts library (hSQL)");
    loadingLabel.setForeground(Color.red);

    itemHolder.add(loadingLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(140, 0, 0, 0), 0, 0));
    loadProgressBar.setIndeterminate(true);
    itemHolder.add(loadProgressBar, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    itemHolder.add(copyrightLabel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
