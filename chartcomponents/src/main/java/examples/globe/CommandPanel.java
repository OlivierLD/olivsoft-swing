...
public class CommandPanel
    ...
    public CommandPanel(SampleFrame caller) {
        ...
        chartPanel = new ChartPanel(this, 800, 600);
    ...
    private void jbInit() throws Exception {
        if ("true".equals(System.getProperty("chart.verbose"))) {
            System.out.println("jbInit invoked on " + this.getClass().getName());
        }
...
//    new GeoPoint(GeomUtil.sexToDec("35", "0"),  GeomUtil.sexToDec("140", "0")), // Tokyo
    ...
    public void chartPanelPaintComponent(Graphics gr) {
        ...
        if ("true".equals(System.getProperty("chart.verbose"))) {
            System.out.println("chartPanelPaintComponent invoked on " + this.getClass().getName());
            System.out.println("Drawing World Chart");
        }
