...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <fo:block text-align="center" font-family="Courier" font-size="10pt" break-after="page" margin="0.1in">
      ...
      <fo:block margin="0.15in">
        <fo:table> <!-- border="0.5pt solid black"> -->
          ...
          <fo:table-column column-width="0.50in"/>   <!-- delta -->
          <fo:table-column column-width="0.75in"/>   <!-- Denebola Distance -->
          <fo:table-column column-width="0.50in"/>   <!-- delta -->
          <fo:table-column column-width="0.25in"/>   <!-- UT -->
          <fo:table-header>
            <fo:table-row>
              ...
              <fo:table-cell number-columns-spanned="2" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt">Denebola</fo:block></fo:table-cell>
              <fo:table-cell number-rows-spanned="2" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt">UT</fo:block></fo:table-cell>
            </fo:table-row>
            <fo:table-row>
              <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$dist"/></fo:block></fo:table-cell>
      ...
      <fo:block margin="0.15in">
        <fo:table> <!-- border="0.5pt solid black"> -->
          ...
          <fo:table-column column-width="0.50in"/>   <!-- delta -->
          <fo:table-column column-width="0.75in"/>   <!-- Rigel Distance -->
          <fo:table-column column-width="0.50in"/>   <!-- delta -->
          <fo:table-column column-width="0.75in"/>   <!-- Procyon Distance -->
          <fo:table-column column-width="0.50in"/>   <!-- delta -->
          ...
          <fo:table-header>
            <fo:table-row>
              ...
              <fo:table-cell number-columns-spanned="2" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt">Rigel</fo:block></fo:table-cell>
              <fo:table-cell number-columns-spanned="2" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt">Procyon</fo:block></fo:table-cell>
  ...
  <xsl:template match="data:data" name="stars-lunar-dist-table-two"> <!-- For one line -->
    ...
    <fo:table-row>
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="xsl-util:decToSex($data/data:stars/data:body[@name='Denebola']/@lunar-dist, $GEOMUTIL.SWING, $GEOMUTIL.NONE)"/></fo:block></fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black">
        <fo:block text-align="right" font-size="6pt">
          <xsl:if test="string-length($data/data:stars/data:body[@name='Denebola']/@delta-lunar) > 0">
            <xsl:value-of select="xsl-util:formatX4($data/data:stars/data:body[@name='Denebola']/@delta-lunar * 60)"/><xsl:text>'</xsl:text>
          </xsl:if>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-weight="bold"><xsl:value-of select="xsl-util:formatI2($data/@hour)"/></fo:block></fo:table-cell>
  ...
  <xsl:template match="data:data" name="stars-lunar-dist-table-three"> <!-- For one line -->
    ...
    <fo:table-row>
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="xsl-util:decToSex($data/data:stars/data:body[@name='Rigel']/@lunar-dist, $GEOMUTIL.SWING, $GEOMUTIL.NONE)"/></fo:block></fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black">
        <fo:block text-align="right" font-size="6pt">
          <xsl:if test="string-length($data/data:stars/data:body[@name='Rigel']/@delta-lunar) > 0">
            <xsl:value-of select="xsl-util:formatX4($data/data:stars/data:body[@name='Rigel']/@delta-lunar * 60)"/><xsl:text>'</xsl:text>
          </xsl:if>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="xsl-util:decToSex($data/data:stars/data:body[@name='Procyon']/@lunar-dist, $GEOMUTIL.SWING, $GEOMUTIL.NONE)"/></fo:block></fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black">
        <fo:block text-align="right" font-size="6pt">
          <xsl:if test="string-length($data/data:stars/data:body[@name='Procyon']/@delta-lunar) > 0">
            <xsl:value-of select="xsl-util:formatX4($data/data:stars/data:body[@name='Procyon']/@delta-lunar * 60)"/><xsl:text>'</xsl:text>
          </xsl:if>
        </fo:block>
      </fo:table-cell>
