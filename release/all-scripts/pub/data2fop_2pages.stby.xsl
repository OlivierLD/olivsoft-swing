    ...
    <xsl:if test="$with-stars = 'true'">
      <fo:block text-align="center" font-family="Courier" font-size="10pt" break-after="page" margin="0.5in">
        ...
        <fo:block text-align="left" font-family="Arial" font-size="7pt">
          ...
          <!--fo:inline font-family="Symbol">abcdefghijklmnopqrstuvwxyz</fo:inline-->
        </fo:block>
        <fo:table>
                ...
                <fo:table-row>
                  <fo:table-cell padding="medium" border="0.5pt solid black">
                    ...
                    <!--xsl:variable name="loc-in-const">
                      <xsl:choose>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'alpha')">
                          <xsl:value-of select="'a'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'alfa')">
                          <xsl:value-of select="'a'"/>
                        </xsl:when>
                    ...
                    <fo:block text-align="left" font-family="Arial" font-size="8pt">&nbsp;<fo:inline font-weight="bold"><xsl:value-of select="./@name"/></fo:inline></fo:block>
                  </fo:table-cell>
