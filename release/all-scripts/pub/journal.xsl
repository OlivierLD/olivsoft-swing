...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:wind-util="http://www.oracle.com/XSL/Transform/java/ocss.nmea.utils.WindUtils"
                ...
                exclude-result-prefixes="data j-string xsl-util geom-util wind-util"
                version="2.0">
                  ...
                  <fo:table-body>
                    ...
                    <xsl:for-each select="./time">
                      <fo:table-row>
                        ...
                        <fo:table-cell border="0.5pt solid black"><fo:block text-align="center"><xsl:value-of select="xsl-util:formatI1(wind-util:getBeaufort(./data[./@id='TWS']))"/></fo:block></fo:table-cell>
