...
public class CheckForUpdateThread extends Thread {
    ...
    public void run() {
        System.out.println(">>> Auto update removed in version 4.0.0.0");
    }

    public void run_() // Removed in Version 4.0.0.0
    {
        String downloadMess = "";
                        ...
                        if (conn != null) {
                            ...
                            try {
                                if (localFile.exists()) {
                                    ...
                                    if (verbose)
                                        System.out.println("Renaming " + oneLineOfUpdate[1] + " (" + localFile.getName() + ") to " + backup.getName());
