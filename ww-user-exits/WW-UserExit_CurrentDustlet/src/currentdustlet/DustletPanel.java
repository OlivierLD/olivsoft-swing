...
//  System.out.println("DustletPanel init");
    ...
    backward.addActionListener(new ActionListener()
        {
          public void actionPerformed(ActionEvent e)
          {
            backwardButton_actionPerformed();
          }
        });
    ...
    motesTextField.setText(Integer.toString(motes));
    motesTextField.addActionListener(new ActionListener()
        {
          public void actionPerformed(ActionEvent e)
          {
            try { motes = Integer.parseInt(motesTextField.getText()); } catch (NumberFormatException ex) {ex.printStackTrace();}
    ...
    currentSizeSpinner.addChangeListener(new ChangeListener()
        {
